...
export default function AdminDashboard() {
  ...
  async function fetchStats() {
    const res = await fetch("https://fin4sure.onrender.com/api/admin/stats", {
      credentials: "include",
    });
  ...
  async function fetchBrokers() {
    const res = await fetch("https://fin4sure.onrender.com/api/admin/brokers", {
      credentials: "include",
    });
  ...
  async function fetchLeads() {
    const res = await fetch(
      `https://fin4sure.onrender.com/api/admin/leads?status=${leadFilter}`,
      { credentials: "include" }
    );
  ...
  async function updateBrokerStatus(brokerId, status) {
    await fetch("https://fin4sure.onrender.com/api/admin/broker-status", {
      method: "POST",
      credentials: "include",
  ...
  async function updateLeadStatus(leadId, status) {
    await fetch("https://fin4sure.onrender.com/api/admin/lead-status", {
      method: "POST",
      credentials: "include",
      headers: { "Content-Type": "application/json" },
  ...
  function exportData(type) {
    ...
    const url =
      `https://fin4sure.onrender.com/api/admin/export?type=${type}&from=${from}&to=${to}`;
    ...
    <div className="min-h-screen bg-linear-to-b from-blue-50 via-white to-white">
      <div className="max-w-7xl mx-auto px-6 py-10 space-y-10">
        ...
        <div className="flex justify-center gap-4">
          ...
          <button className="bg-linear-to-r from-bg-green-500 via-bg-green-550 to-bg-green-700 p-4 rounded-lg
      ...
      <tbody className="bg-white divide-y divide-slate-200">
        {leads.map((l) => (
          <tr key={l._id} className="hover:bg-teal-50 transition">
            ...
            <td className="p-3 hidden md:table-cell font-mono text-xs">{l.dPan}</td>
