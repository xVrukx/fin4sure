...
export  const districtsByState = {
  "Andhra Pradesh": [
    ...
    "Prakasam","SPSR Nellore","Srikakulam","Visakhapatnam",
  ...
  "Chhattisgarh": [
    ...
    "Kanker","Kondagaon","Korba","Koriya",
    "Mahasamund","Mungeli","Narayanpur","Raigarh",
  ...
  "Gujarat": [
    ...
    "Devbhoomi Dwarka","Gandhinagar","Gir Somnath",
  ...
  "Jharkhand": [
    ...
    "Ranchi","Sahebganj","Seraikela Kharsawan",
...
"Manipur": [
  ...
  "Mizoram": [
    ...
    "Lawngtlai","Lunglei","Mamit","Saiha","Serchhip","Saitual"
  ],

  "Nagaland": [
    "Chumoukedima","Dimapur","Kiphire","Kohima","Longleng",
    "Meluri","Mokokchung","Mon","Niuland","Noklak",
    "Peren","Phek","Shamator","Tuensang","Tseminyu","Wokha","Zunheboto"
  ],
  ...
  "Odisha": [
    ...
    "Nuapada","Puri","Rayagada","Sambalpur","Sonepur (Subarnapur)","Sundergarh"
  ],
  ...
  "Uttar Pradesh": [
    ...
    "Firozabad","Gautam Buddh Nagar","Ghazipur","Gorakhpur","Gonda","Hamirpur",
...
"Delhi": [
  ...
  "North Delhi","North East Delhi","North West Delhi","Shahdara",
  ...
  "Ladakh": [
    "Leh","Kargil"
    // Note: proposals for additional districts were announced recently.
  ],
